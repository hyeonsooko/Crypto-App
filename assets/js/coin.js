        ...
        <div class="status">
            ...
            <div class="container">
                <div class="item">
                    ...
                    <div class="links">
                        <a href="${coin.links.homepage}" target="_blank">Visit</a>
                        <a href="${coin.links.whitepaper}" target="_blank">Whitepaper</a>
                    </div>
                </div>
                <div class="item">
                    <p class="str">Community</p>
                    <div class="links">
                        <a href="https://x.com/${coin.links.twitter_screen_name}" target="_blank">Twitter</a>
                        <a href="https:/facebook.com/${coin.links.facebooK_username}" target="_blank">Facebook</a>
                    </div>
                </div>
            </div>
        </div>
